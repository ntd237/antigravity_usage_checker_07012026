"""
Antigravity Usage Checker - Main entry point
...
from src.port_detector import PortDetector
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  agusage              Kiểm tra quota (default)
  agusage --verbose    Hiển thị debug logs
  agusage --no-cache   Không sử dụng cache
